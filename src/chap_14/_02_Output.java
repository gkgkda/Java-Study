...
public class _02_Output {
    public static void main(String[] args) {
        ...
        // %d의 'd'는 10진 정수형식(Decimal Integer)
        System.out.printf("%d%n", 1);   // 1
        System.out.printf("%d %d %d%n", 1, 2, 3);   // 1 2 3
        System.out.printf("%d%n", 1234);    // 1234
        System.out.printf("%6d%n", 1234);   // __1234 (총 6자리의 공간을 확보 후 1234 출력)
        System.out.printf("%06d%n", 1234);  // 001234 (총 6자리의 공간을 확보 후 1234 출력하는데 공백을 0으로 채움)
        System.out.printf("%6d%n", -1234);  // _-1234
        System.out.printf("%+6d%n", 1234);  // _+1234 (항상 +- 기호 표시)
        System.out.printf("%,15d%n", 1000000000);   // __ 1,000,000,000 (세 자리마다 콤마로 구분)
        System.out.printf("%-6d%n", 1234);      // 1234__ (총 6자리의 공간을 확보 후 왼쪽 정렬로 1234 출력)

        // %f의 'f'는 부동 소수점 형식(Floating-point)
        ...
        System.out.printf("%6.2s%n", "Java");    // ____Ja (6자리 공간 확보 후 우측 정렬해서 2글자 출력)
        System.out.printf("%-6.2s%n", "Java");    // Ja____ (6자리 공간 확보 후 좌측 정렬해서 2글자 출력)

        System.out.println("----------- 응용1 -----------");
        System.out.println("이름 영어 수학 평균");
        System.out.println("강백호 " + 90 + " " + 80 + " " + 85.0);     // 강백호 90 80 85.0
        System.out.println("서태웅 " + 100 + " " + 100 + " " + 100.0);  // 서태웅 100 100 100
