...
public class _11_Package {
    public static void main(String[] args) {
        ...
        System.out.println("랜덤 정수 : " + random.nextInt());  // int의 범위 내에서 정수값 반환(-21억 ~ +21억)
        System.out.println("랜덤 정수 (범위) : " + random.nextInt(10));   // 0 이상 10 미만의 정수값
        System.out.println("랜덤 실수 : " + random.nextDouble());   // 0.0 이상 1.0 미만의 실수값
//        System.out.println("랜덤 실수 (범위) : " + random.nextDouble(10));  // nextDouble은 범위 지정 불가
